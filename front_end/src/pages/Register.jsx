    ...
    return (
        <div className="flex flex-col h-dvh justify-center items-center bg-slate-800">
            ...
            <div className="bg-white bg-opacity-20 backdrop-blur-md p-10 rounded-lg shadow-lg w-full max-w-md">
                ...
                <button onClick={auth} type="button" className="mt-5 text-white bg-[#4285F4] hover:bg-[#4285F4]/90 focus:ring-4 focus:outline-none focus:ring-[#4285F4]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#4285F4]/55">
